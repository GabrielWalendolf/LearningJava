...
//Classe que agrupa todas as questões
public class AllQuest {
    //Encapsulamento:
    //Usa private para proteger os atributos, e getters e setters para acessar:
    ...
    public static class Quest_2 {
        ...
        //construtor
        public Quest_2(int numero_verificar) {
            this.numero_verificar = numero_verificar;
        }
        void calcular() {
            int verificando_Par_Impar = numero_verificar % 2;
